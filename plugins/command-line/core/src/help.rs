...
What you set lives in the programmer until you store it:
  ...
  store preset "warm"     keep it as a look, new or merged into one
  preset "warm"           recall it onto the selection, or onto every fixture
                          it knows if nothing is selected
